...
function LossAuditPageContent() {
    ...
    const handleCalculate = async (e) => {
        ...
        // Basic Validation
        if (staff < 5000 || staff > 5000000) {
            alert("Staff salary must be between ₹5,000 and ₹50,00,000");
            return;
        }
        if (marketing < 1000 || marketing > 2000000) {
            alert("Marketing budget must be between ₹1,000 and ₹20,00,000");
            return;
        }
        if (ops < 1000 || ops > 5000000) {
            alert("Operations overheads must be between ₹1,000 and ₹50,00,000");
            return;
        }
        ...
        if (businessId) {
            ...
            try {
                ...
                console.error("Error saving loss audit results:", error);
            } finally {
                setSaving(false);
            }
        }
