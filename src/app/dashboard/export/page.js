...
function ExportPageContent() {
    ...
    const handleCalculate = async (e) => {
        ...
        if (price < 10 || price > 500000) {
            alert("Local price must be between ₹10 and ₹5,00,000");
            return;
        }
        if (qty < 1 || qty > 1000000) {
            alert("Monthly quantity must be between 1 and 10,00,000");
            return;
        }
        ...
        if (businessId) {
            ...
            try {
                ...
                console.error("Error saving export results:", error);
            } finally {
                setSaving(false);
            }
        }
