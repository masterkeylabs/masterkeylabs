        ...
        <div className="min-h-screen bg-[#020617] text-white flex flex-col items-center justify-center p-6 font-sans selection:bg-primary/30">
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="flex flex-col items-center mb-10 text-center">
                    <Link href="/" className="mb-6 overflow-hidden h-16 md:h-20 flex items-center justify-center rounded-xl bg-white/[0.02] px-10 w-full max-w-xs border border-white/5 shadow-inner hover:bg-white/[0.04] transition-all">
