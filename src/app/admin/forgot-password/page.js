    ...
    return (
        <div className="min-h-screen bg-[#020617] text-white flex flex-col items-center justify-center p-6 font-sans selection:bg-primary/30">
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                {/* Form */}
                <form onSubmit={handleSubmit} className="glass rounded-[2rem] p-8 md:p-10 border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
                    <h1 className="text-2xl font-bold mb-3 tracking-tight">Reset Password</h1>
                    ...
                    {success && (
                        <div className="mb-6 p-4 bg-primary/10 border border-primary/20 rounded-xl text-primary text-sm flex items-center gap-3">
                            <span className="material-symbols-outlined text-lg">check_circle</span>
                            <div>
                                <p className="font-bold">Reset code sent to {sentTo}</p>
                                <p className="text-xs text-white/60 mt-1">Redirecting to password reset...</p>
                            </div>
                        </div>
                    )}
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                disabled={success}
                                className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 focus:outline-none focus:border-primary/50 focus:bg-white/10 transition-all text-sm disabled:opacity-50"
