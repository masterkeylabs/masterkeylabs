        ...
        <div className="space-y-8 relative">
            ...
            <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 transition-all duration-1000 ${locked ? 'blur-2xl grayscale pointer-events-none opacity-40 scale-[0.98]' : ''}`}>
                ...
                <ModuleWrapper href={`/dashboard/loss-audit${business?.id ? `?id=${business.id}` : ''}`}>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start mb-6 md:mb-8 gap-4 md:gap-0 text-left w-full">
                        ...
                        <div className="w-full md:w-auto flex flex-row md:flex-col items-center md:items-end justify-between md:justify-start">
                            <div className="text-white/20 group-hover:text-ios-blue transition-colors md:mb-2 hidden md:block">
                ...
                <ModuleWrapper href={`/dashboard/night-loss${business?.id ? `?id=${business.id}` : ''}`}>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start mb-6 md:mb-8 gap-4 md:gap-0 text-left w-full">
                        ...
                        <div className="w-full md:w-auto flex flex-row md:flex-col items-center md:items-end justify-between md:justify-start">
                            <div className="text-white/20 group-hover:text-purple-400 transition-colors md:mb-2 hidden md:block">
                                <span className="material-symbols-outlined text-[20px]">open_in_new</span>
                            </div>
                            <div className="text-left md:text-right">
                ...
                <ModuleWrapper href={`/dashboard/visibility${business?.id ? `?id=${business.id}` : ''}`}>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start mb-6 md:mb-8 gap-4 md:gap-0 text-left w-full">
                        ...
                        <div className="w-full md:w-auto flex flex-row md:flex-col items-center md:items-end justify-between md:justify-start">
                            <div className="text-white/20 group-hover:text-cyan-400 transition-colors md:mb-2 hidden md:block">
                                <span className="material-symbols-outlined text-[20px]">open_in_new</span>
                            </div>
                            <div className="text-left md:text-right">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-6 text-left w-full">
                        {['GMB', 'WEB', 'SOC', 'ADS'].map((sig, i) => {
                            const val = getSigVal(sig);
                            return (
                                <div key={i} className="text-center p-2 rounded-lg bg-white/[0.02] border border-white/5 w-full">
                ...
                <ModuleWrapper href={`/dashboard/ai-threat${business?.id ? `?id=${business.id}` : ''}`}>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start mb-6 md:mb-8 gap-4 md:gap-0 text-left w-full">
                        ...
                        <div className="w-full md:w-auto flex flex-row md:flex-col items-center md:items-end justify-between md:justify-start">
                            <div className="text-white/20 group-hover:text-red-500 transition-colors md:mb-2 hidden md:block">
                                <span className="material-symbols-outlined text-[20px]">open_in_new</span>
                            </div>
                            <div className="text-left md:text-right">
                    ...
                    <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="p-4 rounded-xl bg-white/[0.03] border border-white/5 text-left w-full">
